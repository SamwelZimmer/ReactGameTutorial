...
import { DIRECTION_UP, DIRECTION_LEFT, DIRECTION_RIGHT, DIRECTION_DOWN, BODY_SKINS, ICE_CORNERS, PLACEMENT_TYPE_HERO, PLACEMENT_TYPE_ICE_PICKUP } from "../helpers/consts";
...
export class IcePlacement extends Placement {
    ...
    isSolidForBody(body) {
        // checking for the walls on some of the ice tiles
    ...
    autoMovesBodyOnCollide(body) {
        ...
        // only slide if hero doesn't have the ice pickup
    ...
    changesHeroSkinOnCollide() {
        // if hero has ice pickup, show ice skin
    ...
    renderComponent() {
        const frameCoord = this.corner ? iceTileCornerFramesMap[this.corner] : TILES.ICE
