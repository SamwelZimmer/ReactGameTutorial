...
const level = {
    ...
    placements: [
        ...
        { x: 5, y: 5, type: PLACEMENT_TYPE_GOAL },
        { x: 5, y: 1, type: PLACEMENT_TYPE_FLOUR },
        { x: 4, y: 1, type: PLACEMENT_TYPE_FIRE },
        { x: 1, y: 1, type: PLACEMENT_TYPE_FIRE_PICKUP },
        { x: 1, y: 2, type: PLACEMENT_TYPE_SWITCH_DOOR, isRaised: true },
        { x: 5, y: 4, type: PLACEMENT_TYPE_SWITCH_DOOR, isRaised: false },
        { x: 3, y: 3, type: PLACEMENT_TYPE_SWITCH },
