...
const level = {
    ...
    placements: [
        ...
        { x: 7, y: 3, type: PLACEMENT_TYPE_GOAL },
        { x: 7, y: 1, type: PLACEMENT_TYPE_FLOUR },
        ...
        { x: 7, y: 5, type: PLACEMENT_TYPE_TELEPORT },
        { x: 4, y: 3, type: PLACEMENT_TYPE_TELEPORT },
        ...
        { x: 1, y: 2, type: PLACEMENT_TYPE_LOCK, color: "BLUE" },
        { x: 6, y: 3, type: PLACEMENT_TYPE_LOCK, color: "GREEN" },

        { x: 2, y: 4, type: PLACEMENT_TYPE_KEY, color: "BLUE" },
        { x: 5, y: 5, type: PLACEMENT_TYPE_KEY, color: "GREEN" },
    ],
};
